<template><section>
<h2 id="guo-ji-hua"><a class="header-anchor" href="#guo-ji-hua" aria-hidden="true">¶</a> 国际化</h2>
...
<h2 id="jian-rong"><a class="header-anchor" href="#jian-rong" aria-hidden="true">¶</a> 兼容 <code>vue-i18n@5.x</code></h2>
...
<h2 id="jian-rong-qi-ta-i18n-cha-jian"><a class="header-anchor" href="#jian-rong-qi-ta-i18n-cha-jian" aria-hidden="true">¶</a> 兼容其他 i18n 插件</h2>
...
<h2 id="jian-rong-2"><a class="header-anchor" href="#jian-rong-2" aria-hidden="true">¶</a> 兼容 <code>vue-i18n@6.x</code></h2>
...
<h2 id="tong-guo-cdn-de-fang-shi-jia-zai-yu-yan-wen-jian"><a class="header-anchor" href="#tong-guo-cdn-de-fang-shi-jia-zai-yu-yan-wen-jian" aria-hidden="true">¶</a> 通过 CDN 的方式加载语言文件</h2>
...
<p>如果你需要使用其他的语言，欢迎贡献 PR：只需在 <a href="https://github.com/ElemeFE/element/tree/master/src/locale/lang">这里</a> 添加一个语言配置文件即可。</p>
</section></template>
<style>
  ul.language-list {
    color: #5e6d82;
