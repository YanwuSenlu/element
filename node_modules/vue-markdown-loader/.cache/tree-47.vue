<template><section>
<h2 id="tree"><a class="header-anchor" href="#tree" aria-hidden="true">¶</a> Tree</h2>
...
<demo-block class="demo-box" :jsfiddle="{&quot;html&quot;:&quot;&lt;el-tree :data=\&quot;data\&quot; :props=\&quot;defaultProps\&quot; @node-click=\&quot;handleNodeClick\&quot;&gt;&lt;/el-tree&gt;\n\n\n&quot;,&quot;script&quot;:&quot;\n  export default {\n    data() {\n      return {\n        data: [{\n          label: 'Level one 1',\n          children: [{\n            label: 'Level two 1-1',\n            children: [{\n              label: 'Level three 1-1-1'\n            }]\n          }]\n        }, {\n          label: 'Level one 2',\n          children: [{\n            label: 'Level two 2-1',\n            children: [{\n              label: 'Level three 2-1-1'\n            }]\n          }, {\n            label: 'Level two 2-2',\n            children: [{\n              label: 'Level three 2-2-1'\n            }]\n          }]\n        }, {\n          label: 'Level one 3',\n          children: [{\n            label: 'Level two 3-1',\n            children: [{\n              label: 'Level three 3-1-1'\n            }]\n          }, {\n            label: 'Level two 3-2',\n            children: [{\n              label: 'Level three 3-2-1'\n            }]\n          }]\n        }],\n        defaultProps: {\n          children: 'children',\n          label: 'label'\n        }\n      };\n    },\n    methods: {\n      handleNodeClick(data) {\n        console.log(data);\n      }\n    }\n  };\n&quot;,&quot;style&quot;:null}">
                    <div class="source" slot="source"><el-tree :data="data" :props="defaultProps" @node-click="handleNodeClick"></el-tree>


</div>
                    
                    <div class="highlight" slot="highlight"><pre><code class="hljs language-html"><span class="hljs-tag">&lt;<span class="hljs-name">el-tree</span> <span class="hljs-attr">:data</span>=<span class="hljs-string">"data"</span> <span class="hljs-attr">:props</span>=<span class="hljs-string">"defaultProps"</span> <span class="hljs-attr">@node-click</span>=<span class="hljs-string">"handleNodeClick"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">el-tree</span>&gt;</span>
    ...
    data() {
      <span class="hljs-keyword">return</span> {
        <span class="hljs-attr">data</span>: [{
          <span class="hljs-attr">label</span>: <span class="hljs-string">'Level one 1'</span>,
          <span class="hljs-attr">children</span>: [{
            <span class="hljs-attr">label</span>: <span class="hljs-string">'Level two 1-1'</span>,
            <span class="hljs-attr">children</span>: [{
              <span class="hljs-attr">label</span>: <span class="hljs-string">'Level three 1-1-1'</span>
            }]
          }]
        }, {
          <span class="hljs-attr">label</span>: <span class="hljs-string">'Level one 2'</span>,
          <span class="hljs-attr">children</span>: [{
            <span class="hljs-attr">label</span>: <span class="hljs-string">'Level two 2-1'</span>,
            <span class="hljs-attr">children</span>: [{
              <span class="hljs-attr">label</span>: <span class="hljs-string">'Level three 2-1-1'</span>
            }]
          }, {
            <span class="hljs-attr">label</span>: <span class="hljs-string">'Level two 2-2'</span>,
            <span class="hljs-attr">children</span>: [{
              <span class="hljs-attr">label</span>: <span class="hljs-string">'Level three 2-2-1'</span>
            }]
          }]
        }, {
          <span class="hljs-attr">label</span>: <span class="hljs-string">'Level one 3'</span>,
          <span class="hljs-attr">children</span>: [{
            <span class="hljs-attr">label</span>: <span class="hljs-string">'Level two 3-1'</span>,
            <span class="hljs-attr">children</span>: [{
              <span class="hljs-attr">label</span>: <span class="hljs-string">'Level three 3-1-1'</span>
            }]
          }, {
            <span class="hljs-attr">label</span>: <span class="hljs-string">'Level two 3-2'</span>,
            <span class="hljs-attr">children</span>: [{
              <span class="hljs-attr">label</span>: <span class="hljs-string">'Level three 3-2-1'</span>
            }]
          }]
        }],
...
<h3 id="selectable"><a class="header-anchor" href="#selectable" aria-hidden="true">¶</a> Selectable</h3>
<p>Used for node selection. In the following example, data for each layer is acquired after being clicked. If there is no child data, the expanding icon will disappear.</p>
<demo-block class="demo-box" :jsfiddle="{&quot;html&quot;:&quot;&lt;el-tree :data=\&quot;regions\&quot; :props=\&quot;props\&quot; :load=\&quot;loadNode\&quot; lazy=\&quot;\&quot; show-checkbox @check-change=\&quot;handleCheckChange\&quot;&gt;\n&lt;/el-tree&gt;\n\n\n&quot;,&quot;script&quot;:&quot;\n  export default {\n    data() {\n      return {\n        regions: [{\n          'name': 'region1'\n        }, {\n          'name': 'region2'\n        }],\n        props: {\n          label: 'name',\n          children: 'zones'\n        },\n        count: 1\n      };\n    },\n    methods: {\n      handleCheckChange(data, checked, indeterminate) {\n        console.log(data, checked, indeterminate);\n      },\n      handleNodeClick(data) {\n        console.log(data);\n      },\n      loadNode(node, resolve) {\n        if (node.level === 0) {\n          return resolve([{ name: 'Root1' }, { name: 'Root2' }]);\n        }\n        if (node.level &gt; 3) return resolve([]);\n\n        var hasChild;\n        if (node.data.name === 'region1') {\n          hasChild = true;\n        } else if (node.data.name === 'region2') {\n          hasChild = false;\n        } else {\n          hasChild = Math.random() &gt; 0.5;\n        }\n\n        setTimeout(() =&gt; {\n          var data;\n          if (hasChild) {\n            data = [{\n              name: 'zone' + this.count++\n            }, {\n              name: 'zone' + this.count++\n            }];\n          } else {\n            data = [];\n          }\n\n          resolve(data);\n        }, 500);\n      }\n    }\n  };\n&quot;,&quot;style&quot;:null}">
                    <div class="source" slot="source"><el-tree :data="regions" :props="props" :load="loadNode" lazy="" show-checkbox="" @check-change="handleCheckChange">
</el-tree>


</div>
                    
                    <div class="highlight" slot="highlight"><pre><code class="hljs language-html"><span class="hljs-tag">&lt;<span class="hljs-name">el-tree</span>
    ...
    <span class="hljs-attr">methods</span>: {
      ...
      loadNode(node, resolve) {
        <span class="hljs-keyword">if</span> (node.level === <span class="hljs-number">0</span>) {
          <span class="hljs-keyword">return</span> resolve([{ <span class="hljs-attr">name</span>: <span class="hljs-string">'Root1'</span> }, { <span class="hljs-attr">name</span>: <span class="hljs-string">'Root2'</span> }]);
        }
...
<h3 id="default-expanded-and-default-checked"><a class="header-anchor" href="#default-expanded-and-default-checked" aria-hidden="true">¶</a> Default expanded and default checked</h3>
<p>Tree nodes can be initially expanded or checked</p>
<demo-block class="demo-box" :jsfiddle="{&quot;html&quot;:&quot;&lt;el-tree :data=\&quot;data2\&quot; show-checkbox node-key=\&quot;id\&quot; :default-expanded-keys=\&quot;[2, 3]\&quot; :default-checked-keys=\&quot;[5]\&quot; :props=\&quot;defaultProps\&quot;&gt;\n&lt;/el-tree&gt;\n\n\n&quot;,&quot;script&quot;:&quot;\n  export default {\n    data() {\n      return {\n        data2: [{\n          id: 1,\n          label: 'Level one 1',\n          children: [{\n            id: 4,\n            label: 'Level two 1-1',\n            children: [{\n              id: 9,\n              label: 'Level three 1-1-1'\n            }, {\n              id: 10,\n              label: 'Level three 1-1-2'\n            }]\n          }]\n        }, {\n          id: 2,\n          label: 'Level one 2',\n          children: [{\n            id: 5,\n            label: 'Level two 2-1'\n          }, {\n            id: 6,\n            label: 'Level two 2-2'\n          }]\n        }, {\n          id: 3,\n          label: 'Level one 3',\n          children: [{\n            id: 7,\n            label: 'Level two 3-1'\n          }, {\n            id: 8,\n            label: 'Level two 3-2'\n          }]\n        }],\n        defaultProps: {\n          children: 'children',\n          label: 'label'\n        }\n      };\n    }\n  };\n&quot;,&quot;style&quot;:null}">
                    <div class="source" slot="source"><el-tree :data="data2" show-checkbox="" node-key="id" :default-expanded-keys="[2, 3]" :default-checked-keys="[5]" :props="defaultProps">
</el-tree>


</div>
                    <p>Use <code>default-expanded-keys</code> and <code>default-checked-keys</code> to set initially expanded and initially checked nodes respectively. Note that for them to work, <code>node-key</code> is required. Its value is the name of a key in the data object, and the value of that key should be unique across the whole tree.</p>
        ...
        <span class="hljs-attr">data2</span>: [{
          ...
          <span class="hljs-attr">children</span>: [{
            ...
            <span class="hljs-attr">children</span>: [{
              ...
              <span class="hljs-attr">label</span>: <span class="hljs-string">'Level three 1-1-2'</span>
            }]
          }]
        }, {
...
<h3 id="checking-tree-nodes"><a class="header-anchor" href="#checking-tree-nodes" aria-hidden="true">¶</a> Checking tree nodes</h3>
<demo-block class="demo-box" :jsfiddle="{&quot;html&quot;:&quot;&lt;el-tree :data=\&quot;data2\&quot; show-checkbox=\&quot;\&quot; default-expand-all=\&quot;\&quot; node-key=\&quot;id\&quot; ref=\&quot;tree\&quot; highlight-current :props=\&quot;defaultProps\&quot;&gt;\n&lt;/el-tree&gt;\n\n&lt;div class=\&quot;buttons\&quot;&gt;\n  &lt;el-button @click=\&quot;getCheckedNodes\&quot;&gt;get by node&lt;/el-button&gt;\n  &lt;el-button @click=\&quot;getCheckedKeys\&quot;&gt;get by key&lt;/el-button&gt;\n  &lt;el-button @click=\&quot;setCheckedNodes\&quot;&gt;set by node&lt;/el-button&gt;\n  &lt;el-button @click=\&quot;setCheckedKeys\&quot;&gt;set by key&lt;/el-button&gt;\n  &lt;el-button @click=\&quot;resetChecked\&quot;&gt;reset&lt;/el-button&gt;\n&lt;/div&gt;\n\n\n&quot;,&quot;script&quot;:&quot;\n  export default {\n    methods: {\n      getCheckedNodes() {\n        console.log(this.$refs.tree.getCheckedNodes());\n      },\n      getCheckedKeys() {\n        console.log(this.$refs.tree.getCheckedKeys());\n      },\n      setCheckedNodes() {\n        this.$refs.tree.setCheckedNodes([{\n          id: 5,\n          label: 'Level two 2-1'\n        }, {\n          id: 9,\n          label: 'Level three 1-1-1'\n        }]);\n      },\n      setCheckedKeys() {\n        this.$refs.tree.setCheckedKeys([3]);\n      },\n      resetChecked() {\n        this.$refs.tree.setCheckedKeys([]);\n      }\n    },\n\n    data() {\n      return {\n        data2: [{\n          id: 1,\n          label: 'Level one 1',\n          children: [{\n            id: 4,\n            label: 'Level two 1-1',\n            children: [{\n              id: 9,\n              label: 'Level three 1-1-1'\n            }, {\n              id: 10,\n              label: 'Level three 1-1-2'\n            }]\n          }]\n        }, {\n          id: 2,\n          label: 'Level one 2',\n          children: [{\n            id: 5,\n            label: 'Level two 2-1'\n          }, {\n            id: 6,\n            label: 'Level two 2-2'\n          }]\n        }, {\n          id: 3,\n          label: 'Level one 3',\n          children: [{\n            id: 7,\n            label: 'Level two 3-1'\n          }, {\n            id: 8,\n            label: 'Level two 3-2'\n          }]\n        }],\n        defaultProps: {\n          children: 'children',\n          label: 'label'\n        }\n      };\n    }\n  };\n&quot;,&quot;style&quot;:null}">
                    <div class="source" slot="source"><el-tree :data="data2" show-checkbox="" default-expand-all="" node-key="id" ref="tree" highlight-current="" :props="defaultProps">
</el-tree>
...
<div class="buttons">
  ...
  <el-button @click="resetChecked">reset</el-button>
                    ...
                    <p>This example shows how to get and set checked nodes. They both can be done in two approaches: node and key. If you are taking the key approach, <code>node-key</code> is required.</p>
...
<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"buttons"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">@click</span>=<span class="hljs-string">"getCheckedNodes"</span>&gt;</span>get by node<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">@click</span>=<span class="hljs-string">"getCheckedKeys"</span>&gt;</span>get by key<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">@click</span>=<span class="hljs-string">"setCheckedNodes"</span>&gt;</span>set by node<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">@click</span>=<span class="hljs-string">"setCheckedKeys"</span>&gt;</span>set by key<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">@click</span>=<span class="hljs-string">"resetChecked"</span>&gt;</span>reset<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>
...
<h3 id="custom-node-content"><a class="header-anchor" href="#custom-node-content" aria-hidden="true">¶</a> Custom node content</h3>
<p>The content of tree nodes can be customized, so you can add icons or buttons as you will</p>
<demo-block class="demo-box" :jsfiddle="{&quot;html&quot;:&quot;&lt;el-tree :data=\&quot;data2\&quot; :props=\&quot;defaultProps\&quot; show-checkbox=\&quot;\&quot; node-key=\&quot;id\&quot; default-expand-all :expand-on-click-node=\&quot;false\&quot; :render-content=\&quot;renderContent\&quot;&gt;\n&lt;/el-tree&gt;\n\n\n&quot;,&quot;script&quot;:&quot;\n  let id = 1000;\n\n  export default {\n    data() {\n      return {\n        data2: [{\n          id: 1,\n          label: 'Level one 1',\n          children: [{\n            id: 4,\n            label: 'Level two 1-1',\n            children: [{\n              id: 9,\n              label: 'Level three 1-1-1'\n            }, {\n              id: 10,\n              label: 'Level three 1-1-2'\n            }]\n          }]\n        }, {\n          id: 2,\n          label: 'Level one 2',\n          children: [{\n            id: 5,\n            label: 'Level two 2-1'\n          }, {\n            id: 6,\n            label: 'Level two 2-2'\n          }]\n        }, {\n          id: 3,\n          label: 'Level one 3',\n          children: [{\n            id: 7,\n            label: 'Level two 3-1'\n          }, {\n            id: 8,\n            label: 'Level two 3-2'\n          }]\n        }],\n        defaultProps: {\n          children: 'children',\n          label: 'label'\n        }\n      }\n    },\n\n    methods: {\n      append(store, data) {\n        store.append({ id: id++, label: 'testtest', children: [] }, data);\n      },\n\n      remove(store, data) {\n        store.remove(data);\n      },\n\n      renderContent(h, { node, data, store }) {\n        return (\n          &lt;span&gt;\n            &lt;span&gt;\n              &lt;span&gt;{node.label}&lt;/span&gt;\n            &lt;/span&gt;\n            &lt;span style=\&quot;float: right; margin-right: 20px\&quot;&gt;\n              &lt;el-button size=\&quot;mini\&quot; on-click={ () =&gt; this.append(store, data) }&gt;Append&lt;/el-button&gt;\n              &lt;el-button size=\&quot;mini\&quot; on-click={ () =&gt; this.remove(store, data) }&gt;Delete&lt;/el-button&gt;\n            &lt;/span&gt;\n          &lt;/span&gt;);\n      }\n    }\n  };\n&quot;,&quot;style&quot;:null}">
                    <div class="source" slot="source"><el-tree :data="data2" :props="defaultProps" show-checkbox="" node-key="id" default-expand-all="" :expand-on-click-node="false" :render-content="renderContent">
</el-tree>


</div>
                    <p>Use <code>render-content</code> to assign a render function that returns the content of tree nodes. See Vue's documentation for a detailed introduction of render functions. Note that this demo can't run in jsfiddle because it doesn't support JSX syntax. In a real project, <code>render-content</code> will work if relevant dependencies are correctly configured.</p>
    ...
    data() {
      <span class="hljs-keyword">return</span> {
        data2: [{
          ...
          label: <span class="hljs-string">'Level one 1'</span>,
          children: [{
            id: <span class="hljs-number">4</span>,
            label: <span class="hljs-string">'Level two 1-1'</span>,
            children: [{
              id: <span class="hljs-number">9</span>,
              label: <span class="hljs-string">'Level three 1-1-1'</span>
            }, {
              id: <span class="hljs-number">10</span>,
              label: <span class="hljs-string">'Level three 1-1-2'</span>
            }]
          }]
        }, {
          id: <span class="hljs-number">2</span>,
          label: <span class="hljs-string">'Level one 2'</span>,
          children: [{
            id: <span class="hljs-number">5</span>,
            label: <span class="hljs-string">'Level two 2-1'</span>
          }, {
            id: <span class="hljs-number">6</span>,
            label: <span class="hljs-string">'Level two 2-2'</span>
          }]
        }, {
          id: <span class="hljs-number">3</span>,
          label: <span class="hljs-string">'Level one 3'</span>,
          children: [{
            id: <span class="hljs-number">7</span>,
            label: <span class="hljs-string">'Level two 3-1'</span>
          }, {
            id: <span class="hljs-number">8</span>,
            label: <span class="hljs-string">'Level two 3-2'</span>
          }]
        }],
        defaultProps: {
        ...
        <span class="hljs-keyword">return</span> (
          &lt;span&gt;
            ...
            &lt;span style=<span class="hljs-string">"float: right; margin-right: 20px"</span>&gt;
              &lt;el-button size=<span class="hljs-string">"mini"</span> on-click={ () =&gt; <span class="hljs-keyword">this</span>.append(store, data) }&gt;Append&lt;/el-button&gt;
              &lt;el-button size=<span class="hljs-string">"mini"</span> on-click={ () =&gt; <span class="hljs-keyword">this</span>.remove(store, data) }&gt;Delete&lt;/el-button&gt;
            &lt;/span&gt;
          &lt;/span&gt;);
      }
    }
...
<h3 id="tree-node-filtering"><a class="header-anchor" href="#tree-node-filtering" aria-hidden="true">¶</a> Tree node filtering</h3>
<p>Tree nodes can be filtered</p>
<demo-block class="demo-box" :jsfiddle="{&quot;html&quot;:&quot;&lt;el-input placeholder=\&quot;Filter keyword\&quot; v-model=\&quot;filterText\&quot;&gt;\n&lt;/el-input&gt;\n\n&lt;el-tree class=\&quot;filter-tree\&quot; :data=\&quot;data2\&quot; :props=\&quot;defaultProps\&quot; default-expand-all :filter-node-method=\&quot;filterNode\&quot; ref=\&quot;tree2\&quot;&gt;\n&lt;/el-tree&gt;\n\n\n&quot;,&quot;script&quot;:&quot;\n  export default {\n    watch: {\n      filterText(val) {\n        this.$refs.tree2.filter(val);\n      }\n    },\n\n    methods: {\n      filterNode(value, data) {\n        if (!value) return true;\n        return data.label.indexOf(value) !== -1;\n      }\n    },\n\n    data() {\n      return {\n        filterText: '',\n        data2: [{\n          id: 1,\n          label: 'Level one 1',\n          children: [{\n            id: 4,\n            label: 'Level two 1-1',\n            children: [{\n              id: 9,\n              label: 'Level three 1-1-1'\n            }, {\n              id: 10,\n              label: 'Level three 1-1-2'\n            }]\n          }]\n        }, {\n          id: 2,\n          label: 'Level one 2',\n          children: [{\n            id: 5,\n            label: 'Level two 2-1'\n          }, {\n            id: 6,\n            label: 'Level two 2-2'\n          }]\n        }, {\n          id: 3,\n          label: 'Level one 3',\n          children: [{\n            id: 7,\n            label: 'Level two 3-1'\n          }, {\n            id: 8,\n            label: 'Level two 3-2'\n          }]\n        }],\n        defaultProps: {\n          children: 'children',\n          label: 'label'\n        }\n      };\n    }\n  };\n&quot;,&quot;style&quot;:null}">
                    <div class="source" slot="source"><el-input placeholder="Filter keyword" v-model="filterText">
</el-input>
...
<el-tree class="filter-tree" :data="data2" :props="defaultProps" default-expand-all="" :filter-node-method="filterNode" ref="tree2">
                    ...
                    <p>Invoke the <code>filter</code> method of the Tree instance to filter tree nodes. Its parameter is the filtering keyword. Note that for it to work, <code>filter-node-method</code> is required, and its value is the filtering method.</p>
  ...
  <span class="hljs-attr">placeholder</span>=<span class="hljs-string">"Filter keyword"</span>
...
<h3 id="accordion"><a class="header-anchor" href="#accordion" aria-hidden="true">¶</a> Accordion</h3>
<p>Only one node among the same level can be expanded at one time.</p>
<demo-block class="demo-box" :jsfiddle="{&quot;html&quot;:&quot;&lt;el-tree :data=\&quot;data\&quot; :props=\&quot;defaultProps\&quot; accordion @node-click=\&quot;handleNodeClick\&quot;&gt;\n&lt;/el-tree&gt;\n\n\n&quot;,&quot;script&quot;:&quot;\n  export default {\n    data() {\n      return {\n        data: [{\n          label: 'Level one 1',\n          children: [{\n            label: 'Level two 1-1',\n            children: [{\n              label: 'Level three 1-1-1'\n            }]\n          }]\n        }, {\n          label: 'Level one 2',\n          children: [{\n            label: 'Level two 2-1',\n            children: [{\n              label: 'Level three 2-1-1'\n            }]\n          }, {\n            label: 'Level two 2-2',\n            children: [{\n              label: 'Level three 2-2-1'\n            }]\n          }]\n        }, {\n          label: 'Level one 3',\n          children: [{\n            label: 'Level two 3-1',\n            children: [{\n              label: 'Level three 3-1-1'\n            }]\n          }, {\n            label: 'Level two 3-2',\n            children: [{\n              label: 'Level three 3-2-1'\n            }]\n          }]\n        }],\n        defaultProps: {\n          children: 'children',\n          label: 'label'\n        }\n      };\n    },\n    methods: {\n      handleNodeClick(data) {\n        console.log(data);\n      }\n    }\n  };\n&quot;,&quot;style&quot;:null}">
                    <div class="source" slot="source"><el-tree :data="data" :props="defaultProps" accordion="" @node-click="handleNodeClick">
</el-tree>
...
<tr>
<td>load</td>
<td>method for loading subtree data</td>
...
<td>key of current node, a set only prop</td>
<td>string, number</td>
<td>—</td>
<td>—</td>
</tr>
...
<tr>
<td>children</td>
<td>specify which key of node object is used as the node's subtree</td>
<td>string</td>
<td>—</td>
<td>—</td>
</tr>
...
<h3 id="method"><a class="header-anchor" href="#method" aria-hidden="true">¶</a> Method</h3>
...
<td>Accept a boolean type parameter whose default value is <code>false</code>. If the parameter is <code>true</code>, it only returns the currently selected array of sub-nodes.</td>
</tr>
<tr>
