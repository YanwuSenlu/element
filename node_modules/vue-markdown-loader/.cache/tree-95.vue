...
<h2 id="tree-shu-xing-kong-jian"><a class="header-anchor" href="#tree-shu-xing-kong-jian" aria-hidden="true">¶</a> Tree 树形控件</h2>
...
<h3 id="ke-xuan-ze"><a class="header-anchor" href="#ke-xuan-ze" aria-hidden="true">¶</a> 可选择</h3>
...
<h3 id="mo-ren-zhan-kai-he-mo-ren-xuan-zhong"><a class="header-anchor" href="#mo-ren-zhan-kai-he-mo-ren-xuan-zhong" aria-hidden="true">¶</a> 默认展开和默认选中</h3>
...
<h3 id="shu-jie-dian-de-xuan-ze"><a class="header-anchor" href="#shu-jie-dian-de-xuan-ze" aria-hidden="true">¶</a> 树节点的选择</h3>
...
<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"buttons"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">@click</span>=<span class="hljs-string">"getCheckedNodes"</span>&gt;</span>通过 node 获取<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">@click</span>=<span class="hljs-string">"getCheckedKeys"</span>&gt;</span>通过 key 获取<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">@click</span>=<span class="hljs-string">"setCheckedNodes"</span>&gt;</span>通过 node 设置<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">@click</span>=<span class="hljs-string">"setCheckedKeys"</span>&gt;</span>通过 key 设置<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">@click</span>=<span class="hljs-string">"resetChecked"</span>&gt;</span>清空<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>
...
<h3 id="zi-ding-yi-jie-dian-nei-rong"><a class="header-anchor" href="#zi-ding-yi-jie-dian-nei-rong" aria-hidden="true">¶</a> 自定义节点内容</h3>
...
<demo-block class="demo-box" :jsfiddle="{&quot;html&quot;:&quot;&lt;el-tree :data=\&quot;data2\&quot; :props=\&quot;defaultProps\&quot; show-checkbox=\&quot;\&quot; node-key=\&quot;id\&quot; default-expand-all :expand-on-click-node=\&quot;false\&quot; :render-content=\&quot;renderContent\&quot;&gt;\n&lt;/el-tree&gt;\n\n\n&quot;,&quot;script&quot;:&quot;\n  let id = 1000;\n\n  export default {\n    data() {\n      return {\n        data2: [{\n          id: 1,\n          label: '一级 1',\n          children: [{\n            id: 4,\n            label: '二级 1-1',\n            children: [{\n              id: 9,\n              label: '三级 1-1-1'\n            }, {\n              id: 10,\n              label: '三级 1-1-2'\n            }]\n          }]\n        }, {\n          id: 2,\n          label: '一级 2',\n          children: [{\n            id: 5,\n            label: '二级 2-1'\n          }, {\n            id: 6,\n            label: '二级 2-2'\n          }]\n        }, {\n          id: 3,\n          label: '一级 3',\n          children: [{\n            id: 7,\n            label: '二级 3-1'\n          }, {\n            id: 8,\n            label: '二级 3-2'\n          }]\n        }],\n        defaultProps: {\n          children: 'children',\n          label: 'label'\n        }\n      }\n    },\n\n    methods: {\n      append(store, data) {\n        store.append({ id: id++, label: 'testtest', children: [] }, data);\n      },\n\n      remove(store, data) {\n        store.remove(data);\n      },\n\n      renderContent(h, { node, data, store }) {\n        return (\n          &lt;span&gt;\n            &lt;span&gt;\n              &lt;span&gt;{node.label}&lt;/span&gt;\n            &lt;/span&gt;\n            &lt;span style=\&quot;float: right; margin-right: 20px\&quot;&gt;\n              &lt;el-button size=\&quot;mini\&quot; on-click={ () =&gt; this.append(store, data) }&gt;Append&lt;/el-button&gt;\n              &lt;el-button size=\&quot;mini\&quot; on-click={ () =&gt; this.remove(store, data) }&gt;Delete&lt;/el-button&gt;\n            &lt;/span&gt;\n          &lt;/span&gt;);\n      }\n    }\n  };\n&quot;,&quot;style&quot;:null}">
                    ...
                    <p>使用<code>render-content</code>指定渲染函数，该函数返回需要的节点区内容即可。渲染函数的用法请参考 Vue 文档。注意：由于 jsfiddle 不支持 JSX 语法，所以本例在 jsfiddle 中无法运行。但是在实际的项目中，只要正确地配置了相关依赖，就可以正常运行。</p>
...
<h3 id="jie-dian-guo-lu"><a class="header-anchor" href="#jie-dian-guo-lu" aria-hidden="true">¶</a> 节点过滤</h3>
<p>通过关键字过滤树节点</p>
<demo-block class="demo-box" :jsfiddle="{&quot;html&quot;:&quot;&lt;el-input placeholder=\&quot;输入关键字进行过滤\&quot; v-model=\&quot;filterText\&quot;&gt;\n&lt;/el-input&gt;\n\n&lt;el-tree class=\&quot;filter-tree\&quot; :data=\&quot;data2\&quot; :props=\&quot;defaultProps\&quot; default-expand-all :filter-node-method=\&quot;filterNode\&quot; ref=\&quot;tree2\&quot;&gt;\n&lt;/el-tree&gt;\n\n\n&quot;,&quot;script&quot;:&quot;\n  export default {\n    watch: {\n      filterText(val) {\n        this.$refs.tree2.filter(val);\n      }\n    },\n\n    methods: {\n      filterNode(value, data) {\n        if (!value) return true;\n        return data.label.indexOf(value) !== -1;\n      }\n    },\n\n    data() {\n      return {\n        filterText: '',\n        data2: [{\n          id: 1,\n          label: '一级 1',\n          children: [{\n            id: 4,\n            label: '二级 1-1',\n            children: [{\n              id: 9,\n              label: '三级 1-1-1'\n            }, {\n              id: 10,\n              label: '三级 1-1-2'\n            }]\n          }]\n        }, {\n          id: 2,\n          label: '一级 2',\n          children: [{\n            id: 5,\n            label: '二级 2-1'\n          }, {\n            id: 6,\n            label: '二级 2-2'\n          }]\n        }, {\n          id: 3,\n          label: '一级 3',\n          children: [{\n            id: 7,\n            label: '二级 3-1'\n          }, {\n            id: 8,\n            label: '二级 3-2'\n          }]\n        }],\n        defaultProps: {\n          children: 'children',\n          label: 'label'\n        }\n      };\n    }\n  };\n&quot;,&quot;style&quot;:null}">
                    <div class="source" slot="source"><el-input placeholder="输入关键字进行过滤" v-model="filterText">
</el-input>
...
<h3 id="shou-feng-qin-mo-shi"><a class="header-anchor" href="#shou-feng-qin-mo-shi" aria-hidden="true">¶</a> 手风琴模式</h3>
