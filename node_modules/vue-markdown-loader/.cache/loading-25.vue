<template><section>
<h2 id="loading"><a class="header-anchor" href="#loading" aria-hidden="true">¶</a> Loading</h2>
<p>Show animation while loading data.</p>
<h3 id="loading-inside-a-container"><a class="header-anchor" href="#loading-inside-a-container" aria-hidden="true">¶</a> Loading inside a container</h3>
...
<h3 id="loading-text"><a class="header-anchor" href="#loading-text" aria-hidden="true">¶</a> Loading text</h3>
<p>You can customize a text message.</p>
<demo-block class="demo-box" :jsfiddle="{&quot;html&quot;:&quot;&lt;template&gt;\n  &lt;el-table v-loading=\&quot;loading2\&quot; element-loading-text=\&quot;Loading...\&quot; :data=\&quot;tableData\&quot; style=\&quot;width: 100%\&quot;&gt;\n    &lt;el-table-column prop=\&quot;date\&quot; label=\&quot;Date\&quot; width=\&quot;180\&quot;&gt;\n    &lt;/el-table-column&gt;\n    &lt;el-table-column prop=\&quot;name\&quot; label=\&quot;Name\&quot; width=\&quot;180\&quot;&gt;\n    &lt;/el-table-column&gt;\n    &lt;el-table-column prop=\&quot;address\&quot; label=\&quot;Address\&quot;&gt;\n    &lt;/el-table-column&gt;\n  &lt;/el-table&gt;\n&lt;/template&gt;\n\n\n&quot;,&quot;script&quot;:&quot;\n  export default {\n    data() {\n      return {\n        tableData: [{\n          date: '2016-05-02',\n          name: 'John Smith',\n          address: 'No.1518,  Jinshajiang Road, Putuo District'\n        }, {\n          date: '2016-05-04',\n          name: 'John Smith',\n          address: 'No.1518,  Jinshajiang Road, Putuo District'\n        }, {\n          date: '2016-05-01',\n          name: 'John Smith',\n          address: 'No.1518,  Jinshajiang Road, Putuo District'\n        }],\n        loading2: true\n      };\n    }\n  };\n&quot;,&quot;style&quot;:null}">
  ...
  <el-table v-loading="loading2" element-loading-text="Loading..." :data="tableData" style="width: 100%">
    ...
    <el-table-column prop="address" label="Address">
                    ...
                    <p>Add attribute <code>element-loading-text</code> to the element on which <code>v-loading</code> is bound, and its value will be displayed under the spinner.</p>

                    <div class="highlight" slot="highlight"><pre><code class="hljs language-html"><span class="hljs-tag">&lt;<span class="hljs-name">template</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">el-table</span>
    <span class="hljs-attr">v-loading</span>=<span class="hljs-string">"loading2"</span>
    <span class="hljs-attr">element-loading-text</span>=<span class="hljs-string">"Loading..."</span>
    <span class="hljs-attr">:data</span>=<span class="hljs-string">"tableData"</span>
    <span class="hljs-attr">style</span>=<span class="hljs-string">"width: 100%"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">el-table-column</span>
      <span class="hljs-attr">prop</span>=<span class="hljs-string">"date"</span>
...
<h3 id="full-screen-loading"><a class="header-anchor" href="#full-screen-loading" aria-hidden="true">¶</a> Full screen loading</h3>
...
<demo-block class="demo-box" :jsfiddle="{&quot;html&quot;:&quot;&lt;template&gt;\n  &lt;el-button type=\&quot;primary\&quot; @click=\&quot;openFullScreen\&quot; v-loading.fullscreen.lock=\&quot;fullscreenLoading\&quot;&gt;\n    Full screen loading for 3 seconds\n  &lt;/el-button&gt;\n&lt;/template&gt;\n\n\n&quot;,&quot;script&quot;:&quot;\n  export default {\n    data() {\n      return {\n        fullscreenLoading: false\n      }\n    },\n    methods: {\n      openFullScreen() {\n        this.fullscreenLoading = true;\n        setTimeout(() =&gt; {\n          this.fullscreenLoading = false;\n        }, 3000);\n      }\n    }\n  }\n&quot;,&quot;style&quot;:null}">
  ...
  <el-button type="primary" @click="openFullScreen" v-loading.fullscreen.lock="fullscreenLoading">
    Full screen loading for 3 seconds
                    ...
                    <p>Add the <code>fullscreen</code> modifier to create a full screen mask, and it will append to body. In this case, if you disable scrolling on body, you add another modifier <code>lock</code>.</p>
...
<h3 id="service"><a class="header-anchor" href="#service" aria-hidden="true">¶</a> Service</h3>
