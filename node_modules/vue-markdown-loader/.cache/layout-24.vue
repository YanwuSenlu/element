<template><section><h2 id="layout"><a class="header-anchor" href="#layout" aria-hidden="true">¶</a> Layout</h2>
<p>Quickly and easily create layouts with the basic 24-column.</p>
<h3 id="basic-layout"><a class="header-anchor" href="#basic-layout" aria-hidden="true">¶</a> Basic layout</h3>
...
<h3 id="column-spacing"><a class="header-anchor" href="#column-spacing" aria-hidden="true">¶</a> Column spacing</h3>
...
<h3 id="hybrid-layout"><a class="header-anchor" href="#hybrid-layout" aria-hidden="true">¶</a> Hybrid layout</h3>
...
<h3 id="column-offset"><a class="header-anchor" href="#column-offset" aria-hidden="true">¶</a> Column offset</h3>
...
<el-row :gutter="20">
  <el-col :span="12" :offset="6"><div class="grid-content bg-purple"></div></el-col>
                    ...
                    <p>You can specify the number of column offset by setting the value of <code>offset</code> attribute of Col.</p>
...
<el-row type="flex" class="row-bg" justify="space-around">
  ...
  <el-col :span="6"><div class="grid-content bg-purple"></div></el-col>
                    ...
                    <p>You can enable flex layout by setting <code>type</code> attribute to 'flex', and define the layout of child elements by setting <code>justify</code> attribute with start, center, end, space-between or space-around.</p>
...
<h3 id="responsive-layout"><a class="header-anchor" href="#responsive-layout" aria-hidden="true">¶</a> Responsive Layout</h3>
<p>Taking example by Bootstrap's responsive design, four breakpoints are preset: xs, sm, md and lg.</p>
...
<td>number/object (i.e： {span: 4, offset: 4})</td>
<td>—</td>
<td>—</td>
</tr>
<tr>
...
<tr>
<td>md</td>
<td><code>≥992</code> Responsive columns or column props object</td>
<td>number/object (i.e： {span: 4, offset: 4})</td>
<td>—</td>
<td>—</td>
</tr>
<tr>
<td>lg</td>
<td><code>≥1200</code> Responsive columns or column props object</td>
<td>number/object (i.e： {span: 4, offset: 4})</td>
<td>—</td>
<td>—</td>
</tr>
