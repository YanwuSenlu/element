...
<h2 id="upload-shang-chuan"><a class="header-anchor" href="#upload-shang-chuan" aria-hidden="true">¶</a> Upload 上传</h2>
<p>通过点击或者拖拽上传文件</p>
<h3 id="dian-ji-shang-chuan"><a class="header-anchor" href="#dian-ji-shang-chuan" aria-hidden="true">¶</a> 点击上传</h3>
...
<h3 id="yong-hu-tou-xiang-shang-chuan"><a class="header-anchor" href="#yong-hu-tou-xiang-shang-chuan" aria-hidden="true">¶</a> 用户头像上传</h3>
...
<h3 id="zhao-pian-qiang"><a class="header-anchor" href="#zhao-pian-qiang" aria-hidden="true">¶</a> 照片墙</h3>
...
<h3 id="tu-pian-lie-biao-suo-lue-tu"><a class="header-anchor" href="#tu-pian-lie-biao-suo-lue-tu" aria-hidden="true">¶</a> 图片列表缩略图</h3>
...
<h3 id="shang-chuan-wen-jian-lie-biao-kong-zhi"><a class="header-anchor" href="#shang-chuan-wen-jian-lie-biao-kong-zhi" aria-hidden="true">¶</a> 上传文件列表控制</h3>
...
<h3 id="tuo-zhuai-shang-chuan"><a class="header-anchor" href="#tuo-zhuai-shang-chuan" aria-hidden="true">¶</a> 拖拽上传</h3>
<demo-block class="demo-box" :jsfiddle="{&quot;html&quot;:&quot;&lt;el-upload class=\&quot;upload-demo\&quot; drag action=\&quot;https://jsonplaceholder.typicode.com/posts/\&quot; multiple&gt;\n  &lt;i class=\&quot;el-icon-upload\&quot;&gt;&lt;/i&gt;\n  &lt;div class=\&quot;el-upload__text\&quot;&gt;将文件拖到此处，或&lt;em&gt;点击上传&lt;/em&gt;&lt;/div&gt;\n  &lt;div class=\&quot;el-upload__tip\&quot; slot=\&quot;tip\&quot;&gt;只能上传jpg/png文件，且不超过500kb&lt;/div&gt;\n&lt;/el-upload&gt;\n&quot;,&quot;script&quot;:null,&quot;style&quot;:null}">
                    <div class="source" slot="source"><el-upload class="upload-demo" drag="" action="https://jsonplaceholder.typicode.com/posts/" multiple>
  <i class="el-icon-upload"></i>
  <div class="el-upload__text">将文件拖到此处，或<em>点击上传</em></div>
  <div class="el-upload__tip" slot="tip">只能上传jpg/png文件，且不超过500kb</div>
</el-upload>
...
<h3 id="shou-dong-shang-chuan"><a class="header-anchor" href="#shou-dong-shang-chuan" aria-hidden="true">¶</a> 手动上传</h3>
<demo-block class="demo-box" :jsfiddle="{&quot;html&quot;:&quot;&lt;el-upload class=\&quot;upload-demo\&quot; ref=\&quot;upload\&quot; action=\&quot;https://jsonplaceholder.typicode.com/posts/\&quot; :on-preview=\&quot;handlePreview\&quot; :on-remove=\&quot;handleRemove\&quot; :file-list=\&quot;fileList\&quot; :auto-upload=\&quot;false\&quot;&gt;\n  &lt;el-button slot=\&quot;trigger\&quot; size=\&quot;small\&quot; type=\&quot;primary\&quot;&gt;选取文件&lt;/el-button&gt;\n  &lt;el-button style=\&quot;margin-left: 10px;\&quot; size=\&quot;small\&quot; type=\&quot;success\&quot; @click=\&quot;submitUpload\&quot;&gt;上传到服务器&lt;/el-button&gt;\n  &lt;div slot=\&quot;tip\&quot; class=\&quot;el-upload__tip\&quot;&gt;只能上传jpg/png文件，且不超过500kb&lt;/div&gt;\n&lt;/el-upload&gt;\n\n&quot;,&quot;script&quot;:&quot;\n  export default {\n    data() {\n      return {\n        fileList: [{name: 'food.jpeg', url: 'https://fuss10.elemecdn.com/3/63/4e7f3a15429bfda99bce42a18cdd1jpeg.jpeg?imageMogr2/thumbnail/360x360/format/webp/quality/100'}, {name: 'food2.jpeg', url: 'https://fuss10.elemecdn.com/3/63/4e7f3a15429bfda99bce42a18cdd1jpeg.jpeg?imageMogr2/thumbnail/360x360/format/webp/quality/100'}]\n      };\n    },\n    methods: {\n      submitUpload() {\n        this.$refs.upload.submit();\n      },\n      handleRemove(file, fileList) {\n        console.log(file, fileList);\n      },\n      handlePreview(file) {\n        console.log(file);\n      }\n    }\n  }\n&quot;,&quot;style&quot;:null}">
                    <div class="source" slot="source"><el-upload class="upload-demo" ref="upload" action="https://jsonplaceholder.typicode.com/posts/" :on-preview="handlePreview" :on-remove="handleRemove" :file-list="fileList" :auto-upload="false">
  <el-button slot="trigger" size="small" type="primary">选取文件</el-button>
  <el-button style="margin-left: 10px;" size="small" type="success" @click="submitUpload">上传到服务器</el-button>
  <div slot="tip" class="el-upload__tip">只能上传jpg/png文件，且不超过500kb</div>
</el-upload>
...
<tr>
<td>accept</td>
<td>可选参数, 接受上传的<a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#attr-accept">文件类型</a>（thumbnail-mode 模式下此参数无效）</td>
<td>string</td>
<td>—</td>
<td>—</td>
</tr>
