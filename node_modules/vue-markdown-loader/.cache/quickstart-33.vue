<template><section><h2 id="quick-start"><a class="header-anchor" href="#quick-start" aria-hidden="true">¶</a> Quick start</h2>
<p>This part walks you through the process of using Element in a webpack project.</p>
<h3 id="use-starter-kit"><a class="header-anchor" href="#use-starter-kit" aria-hidden="true">¶</a> Use Starter Kit</h3>
<p>We provide a general <a href="https://github.com/ElementUI/element-starter">project template</a> for you. For those who are familiar with <a href="https://github.com/ElementUI/element-cooking-starter">cooking</a> or <a href="https://github.com/ElementUI/element-in-laravel-starter">Laravel</a>, we also provide corresponding templates, and you can download and use them as well.</p>
<p>If you prefer not to use them, please read the following.</p>
<h3 id="config-files"><a class="header-anchor" href="#config-files" aria-hidden="true">¶</a> Config files</h3>
<p>Create a new project, and its structure should be</p>
<pre><code class="hljs language-text">|- src/  --------------------- source code
    |- App.vue
    |- main.js  -------------- entry
...
<p>Typical configurations for these config files are:</p>
...
<pre><code class="hljs language-json">{
  <span class="hljs-attr">"name"</span>: <span class="hljs-string">"element-starter"</span>,
  <span class="hljs-attr">"scripts"</span>: {
    <span class="hljs-attr">"dev"</span>: <span class="hljs-string">"cross-env NODE_ENV=development webpack-dev-server --inline --hot --port 8086"</span>,
  ...
  <span class="hljs-attr">"dependencies"</span>: {
    <span class="hljs-attr">"element-ui"</span>: <span class="hljs-string">"^1.0.0"</span>,
    <span class="hljs-attr">"vue"</span>: <span class="hljs-string">"^2.1.6"</span>
  },
  <span class="hljs-attr">"devDependencies"</span>: {
    ...
    <span class="hljs-attr">"vue-loader"</span>: <span class="hljs-string">"^9.8.0"</span>,
    <span class="hljs-attr">"webpack"</span>: <span class="hljs-string">"beta"</span>,
    <span class="hljs-attr">"webpack-dev-server"</span>: <span class="hljs-string">"beta"</span>
  }
}
</code></pre>
<br>
...
<span class="hljs-built_in">module</span>.exports = {
  ...
  <span class="hljs-attr">module</span>: {
    <span class="hljs-attr">loaders</span>: [
      ...
      {
        <span class="hljs-attr">test</span>: <span class="hljs-regexp">/\.(png|jpe?g|gif|svg)(\?\S*)?$/</span>,
        <span class="hljs-attr">loader</span>: <span class="hljs-string">'file-loader'</span>,
...
<h3 id="import-element"><a class="header-anchor" href="#import-element" aria-hidden="true">¶</a> Import Element</h3>
<p>You can import Element entirely, or just import what you need. Let's start with fully import.</p>
...
<p>The above imports Element entirely. Note that CSS file needs to be imported separately.</p>
...
<pre><code class="hljs language-bash">npm install babel-plugin-component -D
</code></pre>
...
<p>Next, if you need Button and Select, edit main.js:</p>
<pre><code class="hljs language-javascript"><span class="hljs-keyword">import</span> Vue <span class="hljs-keyword">from</span> <span class="hljs-string">'vue'</span>
...
<p>Full example (Component list reference <a href="https://github.com/ElemeFE/element/blob/dev/components.json">components.json</a>)</p>
<pre><code class="hljs language-javascript"><span class="hljs-keyword">import</span> Vue <span class="hljs-keyword">from</span> <span class="hljs-string">'vue'</span>
...
<p>Now you have implemented Vue and Element to your project, and it's time to write your code. Start development mode:</p>
<pre><code class="hljs language-bash"><span class="hljs-comment"># visit localhost:8086</span>
npm run dev
</code></pre>
<p>Build:</p>
<pre><code class="hljs language-bash">npm run build
</code></pre>
<p>Please refer to each component's documentation to learn how to use them.</p>
</section></template>
