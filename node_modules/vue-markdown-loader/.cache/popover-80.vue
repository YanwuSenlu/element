...
<h2 id="popover-dan-chu-kuang"><a class="header-anchor" href="#popover-dan-chu-kuang" aria-hidden="true">¶</a> Popover 弹出框</h2>
...
<demo-block class="demo-box" :jsfiddle="{&quot;html&quot;:&quot;&lt;el-popover ref=\&quot;popover1\&quot; placement=\&quot;top-start\&quot; title=\&quot;标题\&quot; width=\&quot;200\&quot; trigger=\&quot;hover\&quot; content=\&quot;这是一段内容,这是一段内容,这是一段内容,这是一段内容。\&quot;&gt;\n&lt;/el-popover&gt;\n\n&lt;el-popover ref=\&quot;popover2\&quot; placement=\&quot;bottom\&quot; title=\&quot;标题\&quot; width=\&quot;200\&quot; trigger=\&quot;click\&quot; content=\&quot;这是一段内容,这是一段内容,这是一段内容,这是一段内容。\&quot;&gt;\n&lt;/el-popover&gt;\n\n&lt;el-button v-popover:popover1&gt;hover 激活&lt;/el-button&gt;\n&lt;el-button v-popover:popover2&gt;click 激活&lt;/el-button&gt;\n&lt;el-popover placement=\&quot;right\&quot; title=\&quot;标题\&quot; width=\&quot;200\&quot; trigger=\&quot;focus\&quot; content=\&quot;这是一段内容,这是一段内容,这是一段内容,这是一段内容。\&quot;&gt;\n  &lt;el-button slot=\&quot;reference\&quot;&gt;focus 激活&lt;/el-button&gt;\n&lt;/el-popover&gt;\n&quot;,&quot;script&quot;:null,&quot;style&quot;:null}">
                    <div class="source" slot="source"><el-popover ref="popover1" placement="top-start" title="标题" width="200" trigger="hover" content="这是一段内容,这是一段内容,这是一段内容,这是一段内容。">
</el-popover>
...
<el-popover placement="right" title="标题" width="200" trigger="focus" content="这是一段内容,这是一段内容,这是一段内容,这是一段内容。">
  <el-button slot="reference">focus 激活</el-button>
                    ...
                    <p>设置索引<code>ref</code>，在按钮中，我们注册了自定义指令<code>v-popover</code>，指向索引ID。<code>trigger</code>属性用于设置何时触发 Popover ，提供三种触发方式：<code>hover</code>, <code>click</code> 和 <code>focus</code>。第二种用法通过 <code>slot</code> 指定 reference。</p>
...
<span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">v-popover:popover1</span>&gt;</span>hover 激活<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">v-popover:popover2</span>&gt;</span>click 激活<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">el-popover</span>
  ...
  <span class="hljs-attr">content</span>=<span class="hljs-string">"这是一段内容,这是一段内容,这是一段内容,这是一段内容。"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">slot</span>=<span class="hljs-string">"reference"</span>&gt;</span>focus 激活<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">el-popover</span>&gt;</span>
</code></pre>
</div></demo-block>
<h3 id="qian-tao-xin-xi"><a class="header-anchor" href="#qian-tao-xin-xi" aria-hidden="true">¶</a> 嵌套信息</h3>
...
<el-button v-popover:popover4="">click 激活</el-button>
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">el-table</span> <span class="hljs-attr">:data</span>=<span class="hljs-string">"gridData"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">el-table-column</span> <span class="hljs-attr">width</span>=<span class="hljs-string">"150"</span> <span class="hljs-attr">property</span>=<span class="hljs-string">"date"</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"日期"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">el-table-column</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">el-table-column</span> <span class="hljs-attr">width</span>=<span class="hljs-string">"100"</span> <span class="hljs-attr">property</span>=<span class="hljs-string">"name"</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"姓名"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">el-table-column</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">el-table-column</span> <span class="hljs-attr">width</span>=<span class="hljs-string">"300"</span> <span class="hljs-attr">property</span>=<span class="hljs-string">"address"</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"地址"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">el-table-column</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">el-table</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">el-popover</span>&gt;</span>

<span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">v-popover:popover4</span>&gt;</span>click 激活<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>
...
<h3 id="qian-tao-cao-zuo"><a class="header-anchor" href="#qian-tao-cao-zuo" aria-hidden="true">¶</a> 嵌套操作</h3>
...
<el-button v-popover:popover5="">删除</el-button>
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">style</span>=<span class="hljs-string">"text-align: right; margin: 0"</span>&gt;</span>
    ...
    <span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"primary"</span> <span class="hljs-attr">size</span>=<span class="hljs-string">"mini"</span> <span class="hljs-attr">@click</span>=<span class="hljs-string">"visible2 = false"</span>&gt;</span>确定<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">el-popover</span>&gt;</span>

<span class="hljs-tag">&lt;<span class="hljs-name">el-button</span> <span class="hljs-attr">v-popover:popover5</span>&gt;</span>删除<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>
