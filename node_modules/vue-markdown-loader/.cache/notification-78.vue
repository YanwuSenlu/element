    ...
    <span class="hljs-attr">methods</span>: {
      open() {
        ...
        <span class="hljs-keyword">this</span>.$notify({
          ...
          <span class="hljs-attr">message</span>: h(<span class="hljs-string">'p'</span>, { <span class="hljs-attr">style</span>: <span class="hljs-string">'color: red'</span>}, <span class="hljs-string">'这是提示文案这是提示文案这是提示文案这是提示文案这是提示文案这是提示文案这是提示文案这是提示文案'</span>)
        });
      },
