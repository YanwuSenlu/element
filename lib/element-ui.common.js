	...
	exports.default = {
	    ...
	    model: {
	      ...
	      set: function set(val) {
	        if (this.isGroup) {
	          ...
	          this.group.min !== undefined && val.length < this.group.min && (isLimitExceeded = true);

	          this.group.max !== undefined && val.length > this.group.max && (isLimitExceeded = true);

	          isLimitExceeded === false && this.group.$emit('input', val);
	  ...
	  methods: {
	    ...
	    handleChange: function handleChange(ev) {
	      ...
	      if (this.isGroup) {
	        this.$nextTick(function (_) {
	          _this.group.$emit('change', _this.group.value);
	        });
	      }
	    }
	  },
...
/***/ function(module, exports) {
	...
	exports.default = {
	  ...
	  watch: {
	    value: function value(_value) {
	      this.ElFormItem.$emit('el.form.change', _value);
	    }
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    ifNullSetBegin: function ifNullSetBegin() {
